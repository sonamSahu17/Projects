<div id="sidebar" class="col-md-4">
    ...
    <div class="search-box-container">
        ...
        <!-- <form class="search-post" action="search.php" method ="POST"> -->
                ...
                <input type="text" name="search" class="form-control" id="searchValue" placeholder="Search .....">
...
<script type="text/javascript" src="js/jquery.js"></script>
 <script type="text/javascript">
   $(document).ready(function(){
    ...
    e.preventDefault();
       var search_term = $("#searchValue").val();
       function loadSearchData(page){
  
       $.ajax({
         url: "search.php",
         type: "POST",
         data : {search : search_term,page_no : page},
     ...
     $(document).on("click","ul.paginationOfSearch a",function(event){
  event.preventDefault();
  var page_id1 = $(this).attr("id");


  loadSearchData(page_id1);
  })
});
